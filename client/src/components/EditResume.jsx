    ...
    <DashboardLayout>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6'>
        <div className='flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-gradient-to-r from-white to-violet-50 border border-violet-100 rounded-2xl py-4 px-6 mb-6 shadow-sm'>
          ...
          <div className="flex flex-wrap items-center gap-3">
            <button
              className='flex items-center gap-2 px-3 sm:px-4 py-2 bg-violet-100 text-amber-700 font-bold rounded-xl hover:bg-violet-200 transition-all'
          ...
          <div className='bg-white border border-amber-100 rounded-2xl overflow-hidden shadow-sm'>
            ...
            <div className="p-4 sm:p-6">
              ...
              <div className="flex flex-wrap items-center justify-end gap-3">
                ...
                <button
                  className='flex items-center gap-2 px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-amber-500 to-emerald-500 text-white font-bold rounded-xl hover:scale-105 transition-all shadow-lg text-sm'
      ...
      >
        <div className="relative">
          <div className="text-center mb-4">
            <div className='inline-flex items-center gap-2 bg-violet-100 px-3 py-1 rounded-full text-sm font-medium text-amber-700'>
              <div className='w-2 h-2 rounded-full bg-emerald-500 animate-pulse'></div>
